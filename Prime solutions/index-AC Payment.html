...
<html>
<head>
<title>NewsFlash - AC Payment</title>
...
<table width="783" height="200" border="0" cellspacing="0" cellpadding="0">
  <tr>
     <td width="783" height="100" valign="top"><div class="blok">
       <p><br>
       <br>
       </p>
      <form name="form1" method="post" action="">
       <table width="726" height="357" border="1" cellpadding="3" align="center">
         <tr>
           <td width="161"><strong>Customer name </strong></td>
           <td width="141"><strong>Publication name </strong></td>
           <td width="102"><strong>Total amount </strong></td>
	   ...
	   (Note: After entering Send Email button a polite email will be sent to the customer) 
      </form>
       <p>&nbsp; </p>
     </div></td>
</tr>
